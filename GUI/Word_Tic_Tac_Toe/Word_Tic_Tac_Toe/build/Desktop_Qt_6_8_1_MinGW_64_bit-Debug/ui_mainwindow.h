...
"}"));
        ...
        pushButton_3->setGeometry(QRect(1090, 140, 100, 100));
...
""));
        ...
        pushButton_1->setGeometry(QRect(890, 140, 100, 100));
...
""));
        ...
        pushButton_2->setGeometry(QRect(990, 140, 100, 100));
...
""));
        ...
        pushButton_5->setGeometry(QRect(990, 240, 100, 100));
...
""));
        ...
        pushButton_4->setGeometry(QRect(890, 240, 100, 100));
...
""));
        ...
        pushButton_6->setGeometry(QRect(1090, 240, 100, 100));
...
""));
        ...
        pushButton_8->setGeometry(QRect(990, 340, 100, 100));
...
""));
        ...
        pushButton_7->setGeometry(QRect(890, 340, 100, 100));
...
""));
        ...
        pushButton_9->setGeometry(QRect(1090, 340, 100, 100));
...
""));
        ...
        label->setGeometry(QRect(10, 80, 171, 81));
        QFont font;
        font.setPointSize(20);
        font.setWeight(QFont::Thin);
        label->setFont(font);
        label->setStyleSheet(QString::fromUtf8("    font-weight: 100; /* Thin font weight */\n"
"  color:white;     /* Set text color */\n"
"    background-color: transparent; /* Transparent background */"));
        Dic_status = new QLabel(centralwidget);
        Dic_status->setObjectName("Dic_status");
        Dic_status->setGeometry(QRect(150, 80, 171, 81));
        Dic_status->setFont(font);
        Dic_status->setStyleSheet(QString::fromUtf8("    font-weight: 100; /* Thin font weight */\n"
"    background-color: transparent; /* Transparent background */"));
        label_2 = new QLabel(centralwidget);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(10, -10, 531, 111));
        QFont font1;
...
"}"));
        ...
        player_2_wins->setGeometry(QRect(490, 320, 91, 41));
        player_2_wins->setFont(font);
...
"    background-color: transparent; /* Transparent background */"));
        ...
        Tie_Times->setGeometry(QRect(320, 320, 91, 41));
        Tie_Times->setFont(font);
        Tie_Times->setStyleSheet(QString::fromUtf8("    font-weight: 100; /* Thin font weight */\n"
"  color:white;     /* Set text color */\n"
"    background-color: transparent; /* Transparent background */"));
        label_4 = new QLabel(centralwidget);
        label_4->setObjectName("label_4");
        label_4->setGeometry(QRect(310, 250, 61, 51));
...
"    background-color: transparent; /* Transparent background */"));
        ...
        label_8->setGeometry(QRect(80, 250, 211, 51));
...
"    background-color: transparent; /* Transparent background */"));
        ...
        player_2->setGeometry(QRect(440, 250, 291, 51));
        player_2->setFont(font);
        player_2->setStyleSheet(QString::fromUtf8("    font-weight: 100; /* Thin font weight */\n"
"  color:white;     /* Set text color */\n"
"    background-color: transparent; /* Transparent background */"));
        player_1_wins = new QLabel(centralwidget);
        player_1_wins->setObjectName("player_1_wins");
        player_1_wins->setGeometry(QRect(130, 320, 91, 41));
        player_1_wins->setFont(font);
...
"    background-color: transparent; /* Transparent background */"));
        ...
        Button_player->setGeometry(QRect(20, 530, 101, 51));
        QFont font2;
        Button_player->setFont(font2);
...
"    }"));
        ...
        Button_multi->setGeometry(QRect(170, 530, 111, 51));
        Button_multi->setFont(font2);
...
"    }"));
        ...
        Game_mode->setGeometry(QRect(1170, 540, 211, 51));
        Game_mode->setFont(font);
        Game_mode->setStyleSheet(QString::fromUtf8("    font-weight: 100; /* Thin font weight */\n"
"  color:white;     /* Set text color */\n"
"    background-color: transparent; /* Transparent background */"));
        label_9 = new QLabel(centralwidget);
        label_9->setObjectName("label_9");
        label_9->setGeometry(QRect(1000, 540, 211, 51));
...
"    background-color: transparent; /* Transparent background */"));
        ...
        Reset_score->setGeometry(QRect(1180, 20, 141, 51));
        Reset_score->setFont(font2);
...
"    }"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QCoreApplication::translate("MainWindow", "File Status :", nullptr));
        Dic_status->setText(QString());
        label_2->setText(QCoreApplication::translate("MainWindow", "Word Tic - Tac - Toe ", nullptr));
        ...
        label_8->setText(QCoreApplication::translate("MainWindow", "Player 1 (\360\237\237\240) ", nullptr));
        player_2->setText(QCoreApplication::translate("MainWindow", "Player 2 (\360\237\224\265) ", nullptr));
